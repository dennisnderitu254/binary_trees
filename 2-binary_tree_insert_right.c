...
4. If the parent’s right child is not NULL, set the new node’s right child to the parent’s right child, and set the parent of the parent’s right child to the new node.
